...
dependencies {
    ...
    implementation("com.google.firebase:firebase-messaging:23.1.2") // Ajout de Firebase Messaging
    implementation("com.google.firebase:firebase-core:21.3.0") // Ajout de Firebase Core
}
